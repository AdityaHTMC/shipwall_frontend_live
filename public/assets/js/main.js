...
(function ($) {
	...
	$('.tp-slider-active-4').slick({
		...
		fade: true,
		centerMode: true,
		prevArrow: `<button type="button" class="tp-slider-3-button-prev"><svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="../../../../external.html?link=http://www.w3.org/2000/svg">
		...
		nextArrow: `<button type="button" class="tp-slider-3-button-next"><svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="../../../../external.html?link=http://www.w3.org/2000/svg">
