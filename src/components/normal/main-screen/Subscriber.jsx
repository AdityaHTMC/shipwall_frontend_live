  ...
  return (
    ...
    <div className="tp-subscribe-shape">
        ...
        <div className="tp-subscribe-plane">
            ...
            <svg width="399" height="110" className="d-none d-sm-block" viewBox="0 0 399 110" fill="none">
            ...
            <svg className="d-sm-none" width="193" height="110" viewBox="0 0 193 110" fill="none">
        ...
        <div className="row align-items-center">
            ...
            <div className="col-xl-5 col-lg-5">
                <div className="tp-subscribe-form">
                    <form action="#">
                        <div className="tp-subscribe-input m-auto">
                            <input type="email" placeholder="Enter Your Email"/>
                            <button className='pb-4 '  type="submit">Subscribe</button>
                        </div>
                    </form>
                </div>
            </div>
