...
import ProductQuickView from '../main-screen/ProductQuickView'

const MainProduct = () => {
  const { limitProducts, addToCart,addWishlist} = useAppContext()
          ...
          <div className="tp-product-action">
            <div className="tp-product-action-item d-flex flex-column">
              ...
              <button
                ...
                onClick={() => HandelQuickView(item._id)}
              >
                <svg
                  width={20}
                  height={17}
